...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_InputLine = 17,                 /* InputLine  */
  YYSYMBOL_18_1 = 18,                      /* $@1  */
  YYSYMBOL_19_2 = 19,                      /* $@2  */
  YYSYMBOL_End = 20,                       /* End  */
  YYSYMBOL_Chain = 21,                     /* Chain  */
  YYSYMBOL_22_3 = 22,                      /* $@3  */
  YYSYMBOL_Redirections = 23,              /* Redirections  */
  YYSYMBOL_Pipeline = 24,                  /* Pipeline  */
...
{
       0,    53,    53,    55,    56,    56,    57,    57,    58,    59,
      60,    63,    64,    65,    68,    69,    69,    72,    73,    74,
      75,    76,    79,    80,    83,    83,    85,    85,    89
};
#endif
...
static const char *const yytname[] =
{
  ...
  "PIPE_OP", "NEWLINE", "$accept", "program", "InputLine", "$@1", "$@2",
  "End", "Chain", "$@3", "Redirections", "Pipeline", "Command", "$@4",
  "Options", "$@5", YY_NULLPTR
};
...
{
       4,   -11,   -11,    11,   -11,    -4,    -3,    -1,     9,     9,
     -11,     4,   -11,   -11,     3,   -11,     4,    13,    14,   -11,
      17,   -11,   -11,   -11,   -11,     4,     4,   -11,   -11,    10,
      15,   -11,     9,   -11,   -11,    16,    19,   -11,   -11,   -11
};
...
{
      10,    24,    15,     0,     2,     9,    21,    23,    28,    28,
       1,    10,     6,     4,    11,    12,    10,     0,     0,    14,
       0,    26,    25,    16,     3,    10,    10,    13,     8,    19,
      20,    22,    28,     7,     5,     0,     0,    27,    18,    17
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -11,   -11,   -10,   -11,   -11,   -11,   -11,   -11,   -11,     5,
     -11,   -11,    -9,   -11
};
...
{
      23,    24,    11,    12,    13,    14,    28,     1,    17,    18,
      15,    10,    20,    21,     2,    33,    34,    27,    29,    30,
       1,    38,    35,    37,    39,    31,    36
};

static const yytype_int8 yycheck[] =
{
       9,    11,     6,     7,     8,     9,    16,     3,    11,    12,
      14,     0,    13,     4,    10,    25,    26,    14,     5,     5,
       3,     5,    12,    32,     5,    20,    11
};
...
{
       0,     3,    10,    16,    17,    21,    24,    25,    26,    22,
       0,     6,     7,     8,     9,    14,    20,    11,    12,    23,
      13,     4,    27,    27,    17,    19,    18,    14,    17,     5,
       5,    24,    28,    17,    17,    12,    11,    27,     5,     5
};

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
static const yytype_int8 yyr1[] =
{
       0,    15,    16,    17,    18,    17,    19,    17,    17,    17,
      17,    20,    20,    20,    21,    22,    21,    23,    23,    23,
      23,    23,    24,    24,    26,    25,    28,    27,    27
};
...
#line 1131 "parser.tab.c"
  ...
  case 5: /* InputLine: Chain OR_OP $@1 InputLine  */
#line 56 "parser.y"
                                                 {isOR = -1;alwaysTrue = false;}
...
#line 1143 "parser.tab.c"
  ...
  case 7: /* InputLine: Chain AND_OP $@2 InputLine  */
#line 57 "parser.y"
                                                 {isOR = -1;alwaysTrue = false;}
#line 1149 "parser.tab.c"
    break;

  case 8: /* InputLine: Chain End InputLine  */
#line 58 "parser.y"
                                  {isOR = -1; alwaysTrue = false; (yyval.ival) = (yyvsp[-2].ival);}
#line 1155 "parser.tab.c"
    break;

  case 9: /* InputLine: Chain  */
#line 59 "parser.y"
                    {isOR = -1; alwaysTrue = false; (yyval.ival) = (yyvsp[0].ival);}
#line 1161 "parser.tab.c"
    break;

  case 10: /* InputLine: %empty  */
#line 60 "parser.y"
              {isOR = -1; alwaysTrue = false; (yyval.ival) = 0;}
#line 1167 "parser.tab.c"
    break;

  case 14: /* Chain: Pipeline Redirections  */
#line 68 "parser.y"
...
#line 1179 "parser.tab.c"
  ...
  case 16: /* Chain: BUILTIN $@3 Options  */
#line 69 "parser.y"
                                            {isBuiltIn = true; (yyval.ival) = execChain();}
