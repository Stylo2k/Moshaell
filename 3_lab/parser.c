...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_17_1 = 17,                      /* $@1  */
  YYSYMBOL_InputLine = 18,                 /* InputLine  */
  YYSYMBOL_19_2 = 19,                      /* $@2  */
  YYSYMBOL_20_3 = 20,                      /* $@3  */
  YYSYMBOL_End = 21,                       /* End  */
  YYSYMBOL_Chain = 22,                     /* Chain  */
  YYSYMBOL_23_4 = 23,                      /* $@4  */
  YYSYMBOL_Redirections = 24,              /* Redirections  */
  YYSYMBOL_Pipeline = 25,                  /* Pipeline  */
  YYSYMBOL_26_5 = 26,                      /* $@5  */
...
{
       0,    44,    44,    44,    46,    47,    47,    48,    48,    49,
      50,    51,    54,    55,    56,    59,    65,    65,    75,    83,
      89,    90,    91,    95,    94,   109,   127,   127,   132,   132,
     136
};
#endif
...
static const char *const yytname[] =
{
  ...
  "PIPE_OP", "NEWLINE", "$accept", "program", "$@1", "InputLine", "$@2",
  "$@3", "End", "Chain", "$@4", "Redirections", "Pipeline", "$@5",
  "Command", "$@6", "Options", "$@7", YY_NULLPTR
};
...
{
     -12,     9,    -2,   -12,   -12,   -12,   -12,    -3,     1,     2,
       6,     6,    -2,   -12,   -12,     0,   -12,    -2,    13,    14,
     -12,   -12,   -12,   -12,   -12,   -12,    -2,    -2,   -12,   -12,
       8,    10,    20,     6,   -12,   -12,    19,    21,   -12,   -12,
     -12,   -12
};
...
{
       2,     0,    11,     1,    26,    16,     3,    10,    22,    25,
      30,    30,    11,     7,     5,    12,    13,    11,     0,     0,
      15,    23,    28,    27,    17,     4,    11,    11,    14,     9,
      20,    21,     0,    30,     8,     6,     0,     0,    24,    29,
      19,    18
};
...
{
      24,     4,    25,    12,    13,    14,    15,    29,     5,     3,
      22,    16,    18,    19,    28,    21,    34,    35,    30,    31,
      36,    37,    39,     4,    40,    38,    41
};

static const yytype_int8 yycheck[] =
{
      11,     3,    12,     6,     7,     8,     9,    17,    10,     0,
       4,    14,    11,    12,    14,    13,    26,    27,     5,     5,
      12,    11,    33,     3,     5,    32,     5
};
...
{
       0,    16,    17,     0,     3,    10,    18,    22,    25,    27,
      28,    23,     6,     7,     8,     9,    14,    21,    11,    12,
      24,    13,     4,    29,    29,    18,    20,    19,    14,    18,
       5,     5,    26,    30,    18,    18,    12,    11,    25,    29,
       5,     5
};
...
{
       0,    15,    17,    16,    18,    19,    18,    20,    18,    18,
      18,    18,    21,    21,    21,    22,    23,    22,    24,    24,
      24,    24,    24,    26,    25,    25,    28,    27,    30,    29,
      29
};
...
#line 75 "parser.y"
                                        {
                                          ...
                                          configureInput(getCommandAt(currentRedirIndex), open((yyvsp[-2].str), O_RDONLY, 0600)); 
                                          currentRedirIndex++;
                                          printf("here index is: %d\n", currentRedirIndex);
                                          configureOutput(getCommandAt(currentRedirIndex), open((yyvsp[0].str), O_TRUNC|O_CREAT|O_WRONLY, 0600)); 
                                          currentRedirIndex++;
                                        }
...
#line 83 "parser.y"
                                        {
                                          configureOutput(getCommandAt(currentRedirIndex), open((yyvsp[-2].str), O_TRUNC|O_CREAT|O_WRONLY, 0600)); 
                                          currentRedirIndex++;
                                          configureInput(getCommandAt(currentRedirIndex), open((yyvsp[0].str), O_RDONLY, 0600)); 
                                          currentRedirIndex++;
                                        }
...
#line 89 "parser.y"
                                        {configureOutput(getCommandAt(currentRedirIndex), open((yyvsp[0].str), O_TRUNC|O_CREAT|O_WRONLY, 0600));  currentRedirIndex++;}
#line 1238 "parser.tab.c"
    break;

  case 21: /* Redirections: LT FILENAME  */
#line 90 "parser.y"
                                        {configureInput(getCommandAt(currentRedirIndex), open((yyvsp[0].str), O_RDONLY, 0600));  currentRedirIndex++;}
...
#line 1262 "parser.tab.c"
  ...
  case 24: /* Pipeline: Command PIPE_OP $@5 Pipeline  */
#line 108 "parser.y"
                     {(yyval.ival) = (yyvsp[0].ival);}
#line 1268 "parser.tab.c"
    break;

  case 25: /* Pipeline: Command  */
#line 109 "parser.y"
                    {
                      // int exitHere = 0;
                      // if (latestCMDPiped) {
...
#line 1297 "parser.tab.c"
  ...
  case 27: /* Command: EXECUTABLE $@6 Options  */
#line 130 "parser.y"
