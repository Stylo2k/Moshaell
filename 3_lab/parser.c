...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_18_1 = 18,                      /* $@1  */
  YYSYMBOL_InputLine = 19,                 /* InputLine  */
  YYSYMBOL_20_2 = 20,                      /* $@2  */
  YYSYMBOL_21_3 = 21,                      /* $@3  */
  YYSYMBOL_End = 22,                       /* End  */
  YYSYMBOL_Chain = 23,                     /* Chain  */
  YYSYMBOL_24_4 = 24,                      /* $@4  */
  YYSYMBOL_Redirections = 25,              /* Redirections  */
  YYSYMBOL_Pipeline = 26,                  /* Pipeline  */
  YYSYMBOL_27_5 = 27,                      /* $@5  */
  YYSYMBOL_Command = 28,                   /* Command  */
  YYSYMBOL_29_6 = 29,                      /* $@6  */
  YYSYMBOL_Options = 30,                   /* Options  */
  YYSYMBOL_31_7 = 31,                      /* $@7  */
  YYSYMBOL_32_8 = 32                       /* $@8  */
};
...
{
       0,    40,    40,    40,    42,    43,    43,    44,    44,    45,
      46,    47,    50,    51,    52,    55,    67,    67,    78,    95,
     112,   122,   131,   135,   134,   145,   154,   154,   161,   161,
     166,   166,   190
};
#endif
...
static const char *const yytname[] =
{
  ...
  "PIPE_OP", "NEWLINE", "GLOB", "$accept", "program", "$@1", "InputLine",
  "$@2", "$@3", "End", "Chain", "$@4", "Redirections", "Pipeline", "$@5",
  "Command", "$@6", "Options", "$@7", "$@8", YY_NULLPTR
};
...
{
     -12,     5,     3,   -12,   -12,   -12,   -12,     2,    -8,     1,
      -3,    -3,     3,   -12,   -12,     6,   -12,     3,    10,    14,
     -12,   -12,   -12,   -12,   -12,   -12,   -12,     3,     3,   -12,
     -12,     9,    11,    22,    -3,    -3,   -12,   -12,    21,    23,
     -12,   -12,   -12,   -12,   -12
};
...
static const yytype_int8 yydefact[] =
{
      ...
      32,    32,    11,     7,     5,    12,    13,    11,     0,     0,
      15,    23,    28,    30,    27,    17,     4,    11,    11,    14,
       9,    20,    21,     0,    32,    32,     8,     6,     0,     0,
      24,    29,    31,    19,    18
};
...
{
      25,    22,    26,    18,    19,     3,     4,    30,    12,    13,
      14,    15,    23,     5,    21,    31,    16,    36,    37,    32,
      29,    38,    39,    41,    42,     4,    43,    40,    44
};

static const yytype_int8 yycheck[] =
{
      11,     4,    12,    11,    12,     0,     3,    17,     6,     7,
       8,     9,    15,    10,    13,     5,    14,    27,    28,     5,
      14,    12,    11,    34,    35,     3,     5,    33,     5
};
...
{
       0,    17,    18,     0,     3,    10,    19,    23,    26,    28,
      29,    24,     6,     7,     8,     9,    14,    22,    11,    12,
      25,    13,     4,    15,    30,    30,    19,    21,    20,    14,
      19,     5,     5,    27,    31,    32,    19,    19,    12,    11,
      26,    30,    30,     5,     5
};
...
{
       0,    16,    18,    17,    19,    20,    19,    21,    19,    19,
      19,    19,    22,    22,    22,    23,    24,    23,    25,    25,
      25,    25,    25,    27,    26,    26,    29,    28,    31,    30,
      32,    30,    30
};
...
#line 166 "parser.y"
             { 
                        ...
                        glob_t gstruct;
                        int r;
                        r = glob((yyvsp[0].str), GLOB_NOCHECK, NULL, &gstruct);
