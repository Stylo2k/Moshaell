...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_26_5 = 26,                      /* $@5  */
  YYSYMBOL_27_6 = 27,                      /* $@6  */
  YYSYMBOL_AmpEnd = 28,                    /* AmpEnd  */
  YYSYMBOL_End = 29,                       /* End  */
  YYSYMBOL_Chain = 30,                     /* Chain  */
  YYSYMBOL_31_7 = 31,                      /* $@7  */
  YYSYMBOL_Redirections = 32,              /* Redirections  */
  YYSYMBOL_Pipeline = 33,                  /* Pipeline  */
  YYSYMBOL_34_8 = 34,                      /* $@8  */
  YYSYMBOL_Command = 35,                   /* Command  */
  YYSYMBOL_36_9 = 36,                      /* $@9  */
  YYSYMBOL_Options = 37,                   /* Options  */
...
{
       0,    57,    57,    57,    59,    59,    60,    60,    61,    61,
      62,    62,    63,    63,    64,    68,    69,    72,    73,    74,
      77,    78,    78,    81,    98,   115,   125,   134,   143,   158,
     183,   187,   186,   197,   205,   205,   212,   212,   217,   217,
     238
};
#endif
...
static const char *const yytname[] =
{
  ...
  "program", "$@1", "InputLine", "$@2", "$@3", "$@4", "$@5", "$@6",
  "AmpEnd", "End", "Chain", "$@7", "Redirections", "Pipeline", "$@8",
  "Command", "$@9", "Options", "$@10", "$@11", YY_NULLPTR
};
...
{
     -31,    11,     3,   -31,   -31,   -31,   -31,     1,     5,    -8,
      -1,    -1,    10,   -31,   -31,     4,   -31,   -31,   -31,    15,
      17,    20,    21,   -31,   -31,   -31,   -31,   -31,   -31,   -31,
     -31,     3,     3,   -31,     3,    16,    22,    18,   -31,    24,
      -1,    -1,     3,   -31,   -31,   -31,    26,    27,    30,   -31,
     -31,   -31,   -31,   -31,   -31,   -31
};
...
{
       2,     0,    14,     1,    34,    21,     3,    12,    30,    33,
      40,    40,    16,     8,     6,    17,    18,    13,    10,     0,
       0,     0,     0,    20,    31,    36,    38,    35,    22,     4,
      15,    14,    14,    19,    14,    25,    27,    28,    26,     0,
      40,    40,    14,     9,     7,    11,     0,     0,     0,    32,
      37,    39,     5,    24,    23,    29
};
...
{
       0,     1,     2,     6,    42,    32,    31,    34,    17,    29,
      18,     7,    11,    23,     8,    39,     9,    10,    27,    40,
      41
};
...
{
      28,    43,    44,    25,    45,    24,     4,    12,    13,    14,
      15,     3,    52,     5,    26,    16,    19,    20,    33,    15,
      35,    21,    36,    22,    16,    37,    38,     4,    46,    50,
      51,    53,    54,    47,    48,    55,    49,    30
};

static const yytype_int8 yycheck[] =
{
      11,    31,    32,     4,    34,    13,     3,     6,     7,     8,
       9,     0,    42,    10,    15,    14,    11,    12,    14,     9,
       5,    16,     5,    18,    14,     5,     5,     3,    12,    40,
      41,     5,     5,    11,    16,     5,    39,    12
};
...
{
       0,    20,    21,     0,     3,    10,    22,    30,    33,    35,
      36,    31,     6,     7,     8,     9,    14,    27,    29,    11,
      12,    16,    18,    32,    13,     4,    15,    37,    37,    28,
      29,    25,    24,    14,    26,     5,     5,     5,     5,    34,
      38,    39,    23,    22,    22,    22,    12,    11,    16,    33,
      37,    37,    22,     5,     5,     5
};
...
static const yytype_int8 yyr1[] =
{
      ...
      26,    22,    27,    22,    22,    28,    28,    29,    29,    29,
      30,    31,    30,    32,    32,    32,    32,    32,    32,    32,
      32,    34,    33,    33,    36,    35,    38,    37,    39,    37,
      37
};
...
#line 1166 "parser.tab.c"
  ...
  case 4: /* $@2: %empty  */
#line 59 "parser.y"
                                   {backGround = true; execChain();resetFlags();}
#line 1172 "parser.tab.c"
    break;

  case 6: /* $@3: %empty  */
#line 60 "parser.y"
                          {execChain();resetFlags(); isOR = 1;}
#line 1178 "parser.tab.c"
    break;

  case 7: /* InputLine: Chain OR_OP $@3 InputLine  */
#line 60 "parser.y"
...
#line 1184 "parser.tab.c"
  ...
  case 8: /* $@4: %empty  */
#line 61 "parser.y"
                           {execChain();resetFlags(); isOR = 0;}
#line 1190 "parser.tab.c"
    break;

  case 9: /* InputLine: Chain AND_OP $@4 InputLine  */
#line 61 "parser.y"
                                                                           {isOR = -1;setAlwaysTrue(false);}
#line 1196 "parser.tab.c"
  ...
  case 10: /* $@5: %empty  */
#line 62 "parser.y"
                        {execChain();resetFlags();}
#line 1202 "parser.tab.c"
    break;

  case 11: /* InputLine: Chain End $@5 InputLine  */
#line 62 "parser.y"
                                                                             {isOR = -1; setAlwaysTrue(false); (yyval.ival) = (yyvsp[-3].ival);}
...
#line 1214 "parser.tab.c"
  ...
  case 13: /* InputLine: Chain $@6  */
#line 63 "parser.y"
                                                                             {isOR = -1; setAlwaysTrue(false); (yyval.ival) = (yyvsp[-1].ival);}
#line 1220 "parser.tab.c"
    break;

  case 14: /* InputLine: %empty  */
#line 64 "parser.y"
...
#line 1232 "parser.tab.c"
  ...
  case 21: /* $@7: %empty  */
#line 78 "parser.y"
                      {lastBuiltin = (yyvsp[0].str);}
#line 1238 "parser.tab.c"
    break;

  case 23: /* Redirections: LT FILENAME GT FILENAME  */
#line 81 "parser.y"
                                        {
...
#line 1260 "parser.tab.c"
  ...
  case 24: /* Redirections: GT FILENAME LT FILENAME  */
#line 98 "parser.y"
                                        {
                                          if(strcmp((yyvsp[-2].str), (yyvsp[0].str)) == 0) {
                                            printf("Error: input and output files cannot be equal!\n");
...
#line 1282 "parser.tab.c"
  ...
  case 25: /* Redirections: GT FILENAME  */
#line 115 "parser.y"
                                        {
...
#line 1297 "parser.tab.c"
  ...
  case 26: /* Redirections: GT_GT FILENAME  */
#line 125 "parser.y"
                                        {
...
#line 1311 "parser.tab.c"
  ...
  case 27: /* Redirections: LT FILENAME  */
#line 134 "parser.y"
                                        {
...
#line 1325 "parser.tab.c"
  ...
  case 28: /* Redirections: NR_GT FILENAME  */
#line 143 "parser.y"
                                    {
                                          int fd = open((yyvsp[0].str), O_TRUNC|O_CREAT|O_WRONLY, 0666);
                                          if (fd == -1) {
...
#line 1345 "parser.tab.c"
  ...
  case 29: /* Redirections: NR_GT FILENAME NR_GT FILENAME  */
#line 159 "parser.y"
                                              {
                                                int fd = open((yyvsp[-2].str), O_TRUNC|O_CREAT|O_WRONLY, 0666);
                                                int fd1 = open((yyvsp[0].str), O_TRUNC|O_CREAT|O_WRONLY, 0666);
...
#line 1385 "parser.tab.c"
  ...
  case 32: /* Pipeline: Command PIPE_OP $@8 Pipeline  */
#line 194 "parser.y"
                                        {
...
#line 1410 "parser.tab.c"
  ...
  case 35: /* Command: EXECUTABLE $@9 Options  */
#line 208 "parser.y"
                    {
